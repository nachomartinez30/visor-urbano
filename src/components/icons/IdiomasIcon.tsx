...
export const IdiomasIcon = () => {
  const [color, setColor] = useState<Colors>(Colors.white);
  return (
    <div
      onMouseEnter={() => setColor(Colors.blue)}
    ...
    >
      <svg
        ...
        width="51.217"
        height="47.421"
        viewBox="0 0 51.217 47.421"
      >
        <defs>
          <clipPath id="clip-path">
            <rect
              id="Rectangle_6985"
              data-name="Rectangle 6985"
              width="51.217"
              height="47.421"
              fill={color}
            />
